...
-- ===================================================================================
create database salon_MichaelChan;
use salon_MichaelChan;
...
foreign key (kdperawatan) references perawatan(kd_perawatan) ON UPDATE CASCADE ON DELETE cascade);

Create Table DetailPerawatan 
(NoPelanggan Char(6) not null, 
KdPerawatan CHAR(6) not null,
JumlahBeliPerawatan int(3) not null,
foreign key (NoPelanggan) references Pelanggan(No_Pelanggan) ON UPDATE CASCADE ON DELETE CASCADE,
foreign key (kdPerawatan) references Perawatan(Kd_perawatan) ON UPDATE CASCADE ON DELETE CASCADE);
...
FOREIGN KEY (kdPerawatan) references Perawatan(kd_Perawatan) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY (kdProduk) references Produk_Perawatan(kd_Produk) ON UPDATE CASCADE ON DELETE CASCADE);
...
Insert into Produk_Perawatan(Kd_Produk, NamaProduk, jumlah, harga) VAlUES 
...
INSERT INTO DetailPerawatan (NoPelanggan, KdPerawatan, JumlahBeliPerawatan) VALUES 
('PLN001','PRW010', '1'), 
('PLN003','PRW008', '1'), 
('PLN005','PRW006', '1'), 
('PLN007','PRW004', '1'), 
...
drop table detailPerawatan;

INSERT INTO DetailProdukPerawatan (KdPerawatan, KdProduk, JumlahBeliProduk) VALUES 
('PRW010','KDP002','2'), 
('PRW008','KDP005','2'), 
('PRW006','KDP006', '3'), 
('PRW004','KDP005', '1'), 
...
-- ======================================================================================
insert into pelanggan values ('PLN011','Michael Chan','JL. Plaju No. 7,Palembang','0851093333333');
...
-- =====================================================================================================================================
select * from Pelanggan where alamat like"%bukit%" && (table pelanggan in telp like "09%";


-- 2. Tampilkan data perawatan dengan harga antara 75.000 sampai 150.000. (5 Point)
-- =====================================================================================================================================
select * from perawatan where harga >75000 && harga < 150000;
...
-- =====================================================================================================================================
select * from pelanggan where No_Pelanggan in ('PL001', 'PL003', 'PL005');


-- 5. Tambahkan Data pada Tabel detail Perawatan dengan data sebagai berikut (PLN011, PRW010, 2). (10 Point)
-- ========================================================================================================================================
SELECT * from perawatan;
SELECT * from perawatan where SUBSTRING(KD_Perawatan = "PRW008)'
